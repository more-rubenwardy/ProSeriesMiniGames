...
While Not KeyHit(1)
	...
	RenderWorld tween
	For c.ChaseCam=Each ChaseCam
		Text 0,0,EntityX(c\camera)
		Text 0,15,EntityY(c\camera)
		Text 0,30,EntityZ(c\camera)
	Next
...
c.ChaseCam=New ChaseCam
	...
	EntityType c\camera,TYPE_PLAYER
...
Function Setup()
	...
	PositionEntity wall_sprite,27,-10,-73
